...
func identifyPacket(message string, p Packet, versions int) (string, Packet, int) {
	fmt.Println("Entering identifyPacket func")
	...
	fmt.Println("Exiting identifyPacket func")
	return message, p, versions

}

func parsePacket(message string, p Packet, versions int) (string, Packet, int) {
	message, p, versions = identifyPacket(message, p, versions)
...
func main() {
	...
	// i := 1
	m, p, v := parsePacket(message, p, versions)
	fmt.Println(v, p, packets, m, len(m))
